...
//			
			if(percent==100){
				canvas.restore();
//				canvas.drawText("����", centre - textWidth / 2, centre + textSize/2, paint); //������Ȱٷֱ�
//				canvas.drawColor(Color.WHITE, Mode.CLEAR);
//				canvas.drawText(g, (centre - textWidth / 2)+10, centre + textSize/2, paint);
//				canvas.drawText("����", (centre - textWidth / 2)+10, centre + textSize/2, paint);
			}else{
			 
				canvas.drawText(text, centre - textWidth / 2, centre + textSize/2, paint); //������Ȱٷֱ�
			}
